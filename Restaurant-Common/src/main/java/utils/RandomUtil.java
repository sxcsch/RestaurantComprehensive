...
public class RandomUtil {
     ...
     * 包含字符
     */
    public static final char[] CHARS_ALL = ("1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ!@#$%^&*()"
                    + "[]{}=_+").toCharArray();
    /**仅包含数字*/
    ...
    /**包含数字及字母*/
    //    public static final char[] CHARS_DA = "1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"
    //    .toCharArray();
    ...
    public static void main(String[] args) {
        String s = RandomUtil.randomOfDA(32);
